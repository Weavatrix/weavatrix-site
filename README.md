...
| --- | --- | --- | --- |
| `weavatrix` | 1.9.0, Rust engine 2.7.1 | MIT | 43 read-only, network-free MCP tools via Cargo or npm |
| `weavatrix-rust` | 2.7.1 | MIT | protocol-independent repository-intelligence engine and library |
